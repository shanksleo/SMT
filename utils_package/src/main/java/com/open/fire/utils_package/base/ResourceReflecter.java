...
public class ResourceReflecter {
    private static final String TAG = ResourceReflecter.class.getSimpleName();


    public static <T extends View> T findViewByName(Context paramContext, View view, String paramString) {
        int id = getIdentifier(paramContext, paramString, "id");
